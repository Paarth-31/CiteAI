...
import Link from 'next/link';
import { usePathname } from 'next/navigation';
import CiteViolationsModal from './CiteViolationsModal';
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="transition-colors font-medium text-sm px-4 py-2 rounded-lg font-[var(--font-sans)] text-[#f43f5e] hover:text-[#f0f4f8] hover:bg-[#f43f5e]/20 border border-[#f43f5e]/30 shadow-[0_0_10px_rgba(244,63,94,0.1)]"
              >
                Cite Violations
              </button>
            </div>
        ...
        {showMobileMenu && (
          <div className="md:hidden mt-4 pt-4 border-t border-[#242c3a] space-y-2">
            ...
            <button
              ...
              className="block w-full text-left transition-colors font-medium py-3 px-4 rounded-xl text-sm text-[#f43f5e] hover:text-[#f0f4f8] hover:bg-[#f43f5e]/20"
            >
              Cite Violations
            </button>
